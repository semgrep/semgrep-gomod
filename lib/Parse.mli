...
(**
    Functions for parsing gomod programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a gomod program from a string into a typed OCaml CST.
...
(** Parse a gomod program from a file into a typed OCaml CST.
